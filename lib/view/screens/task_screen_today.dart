...
class TaskScreenToDay extends StatefulWidget {
  const TaskScreenToDay({super.key});

  @override
  State<TaskScreenToDay> createState() => _TaskScreenState();
}

class _TaskScreenState extends State<TaskScreenToDay> {
        ...
        child: Column(
          ...
          children: [
            ...
            StreamBuilder<QuerySnapshot?>(
              stream:
                  homeRepository.getTaskData(userInfo!.uid, "today", "Pending"),
                                    ...
                                    children: [
                                      ...
                                      vm.selectedIndex == index ? Row(
                                              children: [Container(
                                                    ...
                                                    child: InkWell(
                                                        onTap: () {homeRepository.deleteDoc(
                                                ...
                                                Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                        ...
                                                        color: AppColor.mediumBlue),
                                                    child: InkWell(onTap: () {
                                                          homeRepository.updateTaskStatus(snapshot.data!
                                                                      .docs[index].id);
                                                        },
                                                        child: Icon(
                                                          Icons.check,
                                                ...
                                                Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    ...
                                                    color: snapshot.data!.docs[index]
                                                                ["taskPriority"] == 1
                                                        ? AppColor.darkGreen : snapshot.data!.docs[index][
                                                                    "taskPriority"] == 2
                                                            ? AppColor.yellow : snapshot.data!.docs[index]
                                                                        ["taskPriority"] == 3
                                                                ? AppColor.red : AppColor.black,
                                                  ),
                                                ),
                                                Container(
                                                    child: PopupMenuButton(icon: Icon(Icons.more_vert),
                                                  onSelected: (value) {if (value == "edit") {
                                                      titleController.text = snapshot.data!.docs[index]
                                                              ["title"];
                                                      descController.text = snapshot.data!.docs[index]
                                                              ["desc"];
                                                          ...
                                                          return Container(
                                                            ...
                                                            child: Column(
                                                              children: [
                                                                ...
                                                                Button(buttonHeight: HeightX * 0.07,
